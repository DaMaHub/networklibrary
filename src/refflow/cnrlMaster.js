...
CNRLmaster.prototype.indexDatatypes = function () {
  ...
  const indexDTlive = ['cnrl-8856388711', 'cnrl-8856388712', 'cnrl-8856388713', 'cnrl-8856388723', 'cnrl-8856388727', 'cnrl-8356388727', 'cnrl-8326388727', 'cnrl-8326328727', 'cnrl-3356388722', 'cnrl-3356388733', 'cnrl-8856388724', 'cnrl-8856388322', 'cnrl-8856388924', 'cnrl-8856389322', 'cnrl-8856388725']
  return indexDTlive
}
...
CNRLmaster.prototype.indexCompute = function () {
  // index datatype live in network by cnrl // id
  const indexComputelive = ['cnrl-2356388731', 'cnrl-2356388737', 'cnrl-2356388732', 'cnrl-2356383848']
...
CNRLmaster.prototype.lookupContract = function (refIN) {
  ...
  if (refIN === 'cnrl-8856388711') {
    ...
    const subColumn = [{ cnrl: 'cnrl-3339949442', text: 'SDS_P2', active: false }, { cnrl: 'cnrl-3339949443', text: 'SDS_P1', active: false }, { cnrl: 'cnrl-3339949444', text: 'temperature', active: false }, { cnrl: 'cnrl-3339949445', text: 'humidity', active: false }, { cnrl: 'cnrl-3339949446', text: 'airpressure', active: false }]
    ...
    dataCNRLbundle.devicetableStructure = [{ cnrl: 'cnrl-8856388713', text: 'timestamp', active: false }, { cnrl: 'cnrl-', text: 'compref', active: false }, { cnrl: 'cnrl-', text: 'datatype', active: false }, { cnrl: 'cnrl-', text: 'timeseg', active: false }, { cnrl: 'cnrl-', text: 'value', active: false }, { cnrl: 'cnrl-', text: 'device_mac', active: false }, { cnrl: 'cnrl-', text: 'clean', active: false }, { cnrl: 'cnrl-', text: 'tidy', active: false }]
    dataCNRLbundle.apistructure = ['luftdatenGet/<publickey>/<token>/<queryTime>/<deviceID>/']
    const subColumn = [{ cnrl: 'cnrl-3339949442', text: 'SDS_P2', active: false }, { cnrl: 'cnrl-3339949443', text: 'SDS_P1', active: false }, { cnrl: 'cnrl-3339949444', text: 'BME280_temperature', active: false }, { cnrl: 'cnrl-3339949445', text: 'BME280_humidity', active: false }, { cnrl: 'cnrl-3339949446', text: 'BME280_pressure', active: false }]
    dataCNRLbundle.tableStructure[0] = [{ cnrl: 'cnrl-', text: 'publickey', active: false }, { cnrl: 'cnrl-8856388713', text: 'timestamp', active: false }, { cnrl: 'datasub', text: 'sensordata', active: false, data: subColumn }]
    dataCNRLbundle.namespace = 'http://165.227.244.213:8881/'
    dataCNRLbundle.index = []
